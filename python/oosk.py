...
ax4.plot([   0,  4*T], [960,960], color='blue')
ax4.step([ 4*T + T/2 * 0,  4*T + T/2    ], [960,900], color='magenta')
ax4.step([ 4*T + T/2 * 1,  4*T + T/2 * 2], [900,960], color='magenta')
ax4.step([ 4*T + T/2 * 2,  4*T + T/2 * 3], [960,900], color='magenta')
ax4.step([ 4*T + T/2 * 3,  4*T + T/2 * 4], [900,960], color='magenta')
ax4.step([ 4*T + T/2 * 4,  4*T + T/2 * 5], [960,900], color='magenta')
ax4.step([ 4*T + T/2 * 5,  4*T + T/2 * 6], [900,960], color='magenta')
ax4.step([ 4*T + T/2 * 6,  4*T + T/2 * 7], [960,900], color='magenta')
ax4.step([ 4*T + T/2 * 7,  4*T + T/2 * 8], [900,960], color='magenta')
ax4.plot([ 8*T, 12*T], [960,960], color='blue')
ax4.step([12*T + T/2 * 0, 12*T + T/2    ], [960,900], color='magenta')
ax4.step([12*T + T/2 * 1, 12*T + T/2 * 2], [900,960], color='magenta')
ax4.step([12*T + T/2 * 2, 12*T + T/2 * 3], [960,900], color='magenta')
ax4.step([12*T + T/2 * 3, 12*T + T/2 * 4], [900,960], color='magenta')
ax4.step([12*T + T/2 * 4, 12*T + T/2 * 5], [960,900], color='magenta')
ax4.step([12*T + T/2 * 5, 12*T + T/2 * 6], [900,960], color='magenta')
ax4.step([12*T + T/2 * 6, 12*T + T/2 * 7], [960,900], color='magenta')
ax4.step([12*T + T/2 * 7, 12*T + T/2 * 8], [900,960], color='magenta')
ax4.set_ylim([890,970])
ax4.set_title(r"Moduliertes Signal, Kurzschluss \"uber Modul")
...
fig1.savefig('../images/python/oosk.pgf')
